    ...
    <div class="container-fluid mt-3" style="overflow-x: auto">
        <div class="row">
            ...
            <HeadMenu :currentPage="currentPage" :totalPages="totalPages" @prevPage="prevPage" @nextPage="nextPage"
                @search="filterHolidayBySearchQuery" :getNgayLe="getNgayLe" />

            <!-- Table -->
            <div class="col-12 mt-3" style="overflow-x: auto">
                <HolidayTable :listNgayLe="paginatedData" :currentPage="currentPage" :pageSize="pageSize" :getNgayLe="getNgayLe" />
            </div>
        </div>
    </div>
</template>